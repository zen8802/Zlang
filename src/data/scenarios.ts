...
export const CHARACTER_ROSTER = [
  ...
  { id: 'yuki', name: 'Yuki', nameJP: 'ゆき', emoji: '🏪', voiceId: 'EkK6wL8GaH8IgBZTTDGJ', avatar: '/characters/yuki.png', description: 'Cheerful college student, curious and enthusiastic', personality: 'Energetic, giggly, asks lots of questions.', speechStyle: 'Young casual-polite. ～んですか, ～だよね, some slang.' },
  { id: 'kenji', name: 'Kenji', nameJP: 'けんじ', emoji: '🍻', voiceId: '8BU0fsFBiPt1cbGZ5lK9', avatar: '/characters/kenji.png', description: 'Outgoing coworker in his 30s who loves food', personality: 'Fun, loud after a beer, great organizer.', speechStyle: 'Casual-polite mix. ～しない？ suggestions, English loanwords.' },
