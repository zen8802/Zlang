  ...
  return (
    <div className="min-h-screen bg-[#F5F0EB] flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-4">
        <h1 className="text-2xl font-black text-center text-[#1B4F8A] mb-8" style={{ fontFamily: 'Nunito, sans-serif' }}>
          Lesson Editor
        </h1>

        <button
          onClick={() => router.push('/admin/lessons/enjp')}
          className="w-full bg-white rounded-[20px] p-6 text-left cursor-pointer transition-all hover:-translate-y-1 active:translate-y-[2px]"
          style={{ boxShadow: '0 8px 0 rgba(27,79,138,0.15), 0 2px 16px rgba(0,0,0,0.06)', border: '2px solid #B8CBE0' }}
        >
          <div className="text-3xl mb-2">🇺🇸 → 🇯🇵</div>
          <h2 className="text-xl font-black text-[#1A1A2E]" style={{ fontFamily: 'Nunito, sans-serif' }}>
            English → Japanese
          </h2>
